	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<form name="studentquery" action="/Class-master/CourseController/query/1" method="get">
					<div class="row">
						<div class="col-md-4">
				...
				<table class="table table-striped table-hover animated fadeIn">
					...
					<c:forEach var="course" items="${requestScope.courseList}">
						<tr>
							...
							<td><a class="btn btn-default" href="/Class-master/CourseController/moditystu/${course.cid}">
									修改 </a></td>

							<td><a class="btn btn-default1" class="deleteCss"
								href="/Class-master/CourseController/delete/${course.cid}" onclick="javascript:return deleteconfirm();"> 删除 </a></td>
						</tr>
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<ul class="pagination bg-primary">
				<li><a href="/Class-master/CourseController/query/1?serc=${requestScope.serc}&condition=${requestScope.condition}">首页</a></li>
				<c:if test="${pageInfo.hasPreviousPage }">
					<li><a href="/Class-master/CourseController/query/${pageInfo.pageNum-1}?serc=${requestScope.serc}&condition=${requestScope.condition}"
				...
				<c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
					...
					<c:if test="${page_Num != pageInfo.pageNum }">
						<li><a href="/Class-master/CourseController/query/${page_Num }?serc=${requestScope.serc}&condition=${requestScope.condition}">${page_Num }</a></li>
					</c:if>
				...
				<li><a href="/Class-master/CourseController/query/${pageInfo.pages}?serc=${requestScope.serc}&condition=${requestScope.condition}">末页</a></li>
			</ul>
			</nav>
		</div>
	</div>
...
<script type="text/javascript" src="/Class-master/utils/scripts/flat-ui.js"></script>
<script src="/Class-master/utils/scripts/bganimation.js"></script></body>
</html>