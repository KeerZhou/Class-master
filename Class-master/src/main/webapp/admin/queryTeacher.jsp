...
<div class="container">
		<div class="row">
			<div class="col-md-12">
			<h5>教师管理</h5>
			<form name="studentquery" action="/Class-master/AdminController/queryTea/1" method="get">
				<div class="row">
					<div class="col-md-4">
			...
			<c:forEach var="teacher" items="${requestScope.teacherList}">
				<tr>
					...
					<td><a class="btn btn-default" href="/Class-master/AdminController/modityTea/${teacher.tid}">
							修改 </a></td>

					<td><a class="deleteCss btn btn-default1"
						href="/Class-master/AdminController/deleteTea/${teacher.tid}" onclick="javascript:return deleteconfirm();"> 删除 </a></td>
				</tr>
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<ul class="pagination bg-primary">
				<li><a href="/Class-master/AdminController/queryTea/1?serc=${requestScope.serc}&condition=${requestScope.condition}">首页</a></li>
				<c:if test="${pageInfo.hasPreviousPage }">
					<li><a href="/Class-master/AdminController/queryTea/${pageInfo.pageNum-1}?serc=${requestScope.serc}&condition=${requestScope.condition}"
				...
				<c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
					...
					<c:if test="${page_Num != pageInfo.pageNum }">
						<li><a href="/Class-master/AdminController/queryTea/${page_Num }?serc=${requestScope.serc}&condition=${requestScope.condition}">${page_Num }</a></li>
					</c:if>
				...
				<li><a href="/Class-master/AdminController/queryTea/${pageInfo.pages}?serc=${requestScope.serc}&condition=${requestScope.condition}">末页</a></li>
			</ul>
			</nav>
		</div>
	</div>
