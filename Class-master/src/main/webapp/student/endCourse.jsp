...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<ul class="pagination">
				<li><a href="/Class-master/StudentController/endcourse/${sessionScope.sid }/1">首页</a></li>
				<c:if test="${pageInfo.hasPreviousPage }">
					<li><a href="/Class-master/StudentController/endcourse/${sessionScope.sid }/${pageInfo.pageNum-1}"
				...
				<c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
					...
					<c:if test="${page_Num != pageInfo.pageNum }">
						<li><a href="/Class-master/StudentController/endcourse/${sessionScope.sid }/${page_Num }">${page_Num }</a></li>
					</c:if>
				...
				<li><a href="/Class-master/StudentController/endcourse/${sessionScope.sid }/${pageInfo.pages}">末页</a></li>
			</ul>
			</nav>
		</div>
	</div>
