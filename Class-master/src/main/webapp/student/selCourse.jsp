...
<body><div id="particles-js"><canvas class="particles-js-canvas-el" width="1322" height="774" style="width: 100%; height: 100%;"></canvas></div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
			<h5>选课</h5>
				<form name="studentquery" action="/Class-master/StudentController/queryy/1" method="get">
					<div class="row">
						<div class="col-md-4">
						...
						<table
							...
							<c:forEach var="course" items="${requestScope.courseList}">
								<tr>
									...
									<td>
										<form action="/Class-master/StudentController/seling" method="get">
											<input type="hidden" name="cid" value="${course.cid }" /> <input
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<ul class="pagination bg-primary">
				<li><a href="/Class-master/StudentController/queryy/1?serc=${requestScope.serc}&condition=${requestScope.condition}">首页</a></li>
				<c:if test="${pageInfo.hasPreviousPage }">
					<li><a href="/Class-master/StudentController/queryy/${pageInfo.pageNum-1}?serc=${requestScope.serc}&condition=${requestScope.condition}"
				...
				<c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
					...
					<c:if test="${page_Num != pageInfo.pageNum }">
						<li><a href="/Class-master/StudentController/queryy/${page_Num }?serc=${requestScope.serc}&condition=${requestScope.condition}">${page_Num }</a></li>
					</c:if>
				...
				<li><a href="/Class-master/StudentController/queryy/${pageInfo.pages}?serc=${requestScope.serc}&condition=${requestScope.condition}">末页</a></li>
			</ul>
			</nav>
		</div>
	</div>
