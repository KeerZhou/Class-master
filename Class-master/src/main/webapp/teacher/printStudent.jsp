...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<ul class="pagination">
				<li><a href="/Class-master/TeacherController/looksel/${requestScope.cid }/${requestScope.cname}/1">首页</a></li>
				<c:if test="${pageInfo.hasPreviousPage }">
					<li><a href="/Class-master/TeacherController/looksel/${requestScope.cid }/${requestScope.cname}/${pageInfo.pageNum-1}"
				...
				<c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
					...
					<c:if test="${page_Num != pageInfo.pageNum }">
						<li><a href="/Class-master/TeacherController/looksel/${requestScope.cid }/${requestScope.cname}/${page_Num }">${page_Num }</a></li>
					</c:if>
				...
				<li><a href="/Class-master/TeacherController/looksel/${requestScope.cid }/${requestScope.cname}/${pageInfo.pages}">末页</a></li>
			</ul>
			</nav>
		</div>
	</div>
