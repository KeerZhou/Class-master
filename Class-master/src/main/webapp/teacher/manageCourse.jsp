...
<div class="container">
				...
				<c:forEach var="courseplan" items="${sessionScope.coursePlanList}"
					...
					<tr>
						...
						<td><a class="btn btn-default"
							href="/Class-master/CoursePlanController/modicouplan/${courseplan.courseclass}">
								修改 </a></td>
						<td><a class="btn btn-default1"
							href="/Class-master/CoursePlanController/delcouplan/${courseplan.courseclass}/${tid}" onclick="javascript:return deleteconfirm();">
								删除 </a></td>
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<ul class="pagination">
				<li><a href="/Class-master/TeacherController/managecou/${sessionScope.tid }/1">首页</a></li>
				<c:if test="${pageInfo.hasPreviousPage }">
					<li><a href="/Class-master/TeacherController/managecou/${sessionScope.tid }/${pageInfo.pageNum-1}"
				...
				<c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
					...
					<c:if test="${page_Num != pageInfo.pageNum }">
						<li><a href="/Class-master/TeacherController/managecou/${sessionScope.tid }/${page_Num }">${page_Num }</a></li>
					</c:if>
				...
				<li><a href="/Class-master/TeacherController/managecou/${sessionScope.tid }/${pageInfo.pages}">末页</a></li>
			</ul>
			</nav>
		</div>
	</div>
