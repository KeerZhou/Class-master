...
<div class="container">
				...
				<c:forEach var="ssr" items="${requestScope.ssrList}"
					...
					<tr>
						...
						<td><a class="btn btn-default1"
							   href="/Class-master/StudentController/exitsel/${ssr.cid }/${sessionScope.sid}">
							退选 </a></td>
					</tr>
				</c:forEach>
			</table></div></div></div>
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<ul class="pagination">
				<li><a href="/Class-master/StudentController/selcouresult/${sessionScope.sid }/1">首页</a></li>
				<c:if test="${pageInfo.hasPreviousPage }">
					<li><a href="/Class-master/StudentController/selcouresult/${sessionScope.sid }/${pageInfo.pageNum-1}"
				...
				<c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
					...
					<c:if test="${page_Num != pageInfo.pageNum }">
						<li><a href="/Class-master/StudentController/selcouresult/${sessionScope.sid }/${page_Num }">${page_Num }</a></li>
					</c:if>
				...
				<li><a href="/Class-master/StudentController/selcouresult/${sessionScope.sid }/${pageInfo.pages}">末页</a></li>
			</ul>
			</nav>
		</div>
	</div>
