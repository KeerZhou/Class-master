...
<%--									<th>成绩查询</th>--%>
								...
								<c:forEach var="exit" items="${sessionScope.sesList}"
									...
									<tr>
										...
										<td>${exit.totalNum }</td>
										<td>${exit.stuSum }</td>
										<td><a class="btn btn-default" href="/Class-master/TeacherController/looksel/${exit.cid }/${exit.cname}/1">
												查看名单 </a></td>
<%--										<td><a class="btn btn-default" href="/Class-master/TeacherController/endcou/${exit.cid }/${exit.cname}/1">--%>
<%--												结课 </a></td>--%>
<%--										<td><a class="btn btn-default" href="/Class-master/TeacherController/endcougrade/${exit.cid }/${exit.cname}/1">--%>
<%--												查询成绩 </a></td>--%>
									</tr>
								</c:forEach>
							</table>
